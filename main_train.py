...
train_crop_generator, test_crop_generator = data_pipe.crop_tiny_image_generator(batch_size=64)
...
with open('saved_model/train_history/full_models_acc_histroy.sav', 'wb') as file:
    pickle.dump(history, file)
with open('saved_model/train_history/full_models_time_history.sav', 'wb') as file:
    pickle.dump(time_config_callback, file)
model.save('saved_model/full_model.h5')
...
with open('saved_model/train_history/layer_reduced_model_acc_histroy.sav', 'wb') as file:
    pickle.dump(history, file)
with open('saved_model/train_history/layer_reduced_model_time_history.sav', 'wb') as file:
    pickle.dump(time_config_callback, file)
model.save('saved_model/layer_reduced_model.h5')
...
with open('saved_model/train_history/filter_reduced_model_acc_histroy.sav', 'wb') as file:
    pickle.dump(history, file)
with open('saved_model/train_history/filter_reduced_model_time_history.sav', 'wb') as file:
    pickle.dump(time_config_callback, file)
model.save('saved_model/filter_reduced_model.h5')
...
with open('saved_model/train_history/both_reduced_model_acc_histroy.sav', 'wb') as file:
    pickle.dump(history, file)
with open('saved_model/train_history/both_reduced_model_time_history.sav', 'wb') as file:
    pickle.dump(time_config_callback, file)
model.save('saved_model/both_reduced_model.h5')